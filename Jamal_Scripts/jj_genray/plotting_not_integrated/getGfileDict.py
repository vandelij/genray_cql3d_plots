...
# HAVE EQDSK NAME AND LOCATION SETUP AS CLI ARG


#eqdskFile='gNTARC_k14d05H15-BALOO_v1'
...
def getGfileDict(pathprefix = ''):
    ...
    #fileLoc = f'{pathprefix}g147634.04525'#FREEGS_Conventional_Divertor_12102022'#
    fileLoc = f'{pathprefix}'+str(eqdskFile)
